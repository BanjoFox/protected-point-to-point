...
struct _p3primarycfg {
	union {
		struct in_addr  v4;
		struct in6_addr v6;
	} addr;							/*<< Host address that communicates with secondaries */
...
#define p3PCFG_RKWT	3600			/* Default value */
	int				datidx_wait;	/**< Default period to use data array index in seconds */
#define p3PCFG_DIWT	86400			/* Default value */
	int				ctlidx_wait;	/**< Default period to use control array index in seconds */
