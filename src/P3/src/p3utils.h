...
#define p3MSG_FILE	"p3.log"
#define p3MSG_FLAG (O_RDWR | O_APPEND | O_CREAT)
#define p3MSG_MODE ((S_IRUSR | S_IWUSR) | S_IRGRP | S_IROTH)
...
struct _p3util {
	...
	int				msgfile;	/**< Message log file descriptor */
	union {
		struct in_addr  v4;
		struct in6_addr v6;
	} lochost;					/**< Local host address */
	p3host			**remhost;	/**< Remote host definitions for raw socket */
	unsigned int	flag;
#define p3UTL_NRHST 0x0000ffff  /* Number of remote hosts */
#define p3UTL_NINFO 0x00010000  /* Ignore informational messages */
#define p3UTL_NWARN 0x00020000  /* Ignore warning messages */
#define p3UTL_MSGOP 0x00040000  /* Message file is open */
};
