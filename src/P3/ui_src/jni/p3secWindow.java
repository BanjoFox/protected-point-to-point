...
public class p3secWindow extends JFrame
{
	static final long serialVersionUID = 1L;

	private p3secAPI secAPI = null;
 ...
 /**
  *  The P3 secondary window constructor.
  */
	public p3secWindow(String[] args)
	{
		int i;
		String response;
 ...
 */
	private void sendRequest() {
		...
		//Call native method to load p3secAPI.java
		response = secAPI.getResponse(txRequest.getText().toString());
 ...
 */
	private void getNext() {
		...
		response = secAPI.getNext(txRequest.getText().toString());
		txResponse.setText(response);
	}
