/**
 * \file p3secondary.c
 * <h3>Protected Point to Point secondary administrator program file</h3>
 *
 * Copyright (C) Velocite 2010
 *
 * The P3 secondary administrator interface is used to manage configuration data.
 */

#define _p3_SECONDARY 1
#include "p3admin.h"
